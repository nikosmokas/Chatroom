...
public class ServerAdministrationTools extends Thread {
    ...
    // 4. "chatlog" print the list of messages in the DB sent by users
    ...
    // Goes throw the list of sockets and prints the address
    ...
    public boolean changePass(ChatClient client, String pass) {
